...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func insertNewObject(_ sender: Any) {
        ...
        newEvent.title = self.getRandomString(stringLength:10)
    ...
    func getRandomString(stringLength:Int) -> String {
        ...
        let letters:String = "abcdefghijklmnopqrstuvwxyz1234567890"
        // The character array
  ...
  override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        switch type {
            ...
            case .update:
                self.configureCell(tableView.cellForRow(at: indexPath!)! as! CustomTableCell, withEvent: anObject as! Event)
            case .move:
